...
# Architecture: off-topic + jailbreak rails stacked with dialog rails
...
# Distinctive substrings from each 'define bot' response block above.
# If the guardrail response contains any of these, a rail fired.
...
RAIL_INDICATORS = [
    ...
    "feel free to return whenever you have more enterprise",
    "goodbye",
    "outside the scope",
